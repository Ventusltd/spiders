...
The authoritative queue for newly authorized work is [NEXT-50.md](plan-tracker/NEXT-50.md). N01 Cable ownership has a hashed tested checkpoint. N02 Escape1932 passed199/199 served-file checks and live desktop/mobile Escape for all three tools. N03 focus1936 passed200/200 served-file checks and live desktop/mobile focus boundaries for all three tools. N04 readiness1940 and N05 viewport1945 subsequently passed their own served-file and live desktop/mobile cases. A later N06 phone run exposed the transient Module Ready polling race; retain that failure and require N07 observer/lifecycle proof instead of treating earlier passing cases as universal readiness acceptance. Read the ledger before advancing pending features. Read the offline ledger for exact release tuples and receipts.
